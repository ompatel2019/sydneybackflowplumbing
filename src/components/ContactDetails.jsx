  ...
  const contactDetails = [
    {
      ...
      contactDesc: 'Sydney to Wollongong Region', 
    ...
    <section className='responsivePad 2xl:py-32 lg:py-24 md:py-20 py-12 font-satoshi space-y-8 bg-white-0'>
      ...
      <div className='grid grid-cols-3 max-md:grid-cols-1 gap-4'>
        {contactDetails.map((contactDetail, index) => (
          <div key={index} className='border-l-[3px] max-md:border-l-2 border-black-0 p-4 space-y-2 flex flex-col justify-between'>
            <div className='flex space-x-2 items-center'>
              <contactDetail.contactIcon className='w-8 h-8'/>
            ...
            <a target='_blank' className='font-bold' href={contactDetail.contactLink}>{contactDetail.contactLinkName}</a>
