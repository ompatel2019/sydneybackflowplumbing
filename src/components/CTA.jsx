      ...
      <section className={`responsivePad 2xl:py-32 lg:py-24 md:py-20 py-12 space-y-12 max-md:space-y-4 p ${backgroundColour} ${textColour}`}>
        ...
        <div className='flex space-x-4 items-center justify-center h7 font-satoshi-medium'>
          <a href="tel:0413536277">
            <button className='bg-grey-0 px-4 p-3 rounded-[4px] transition-all ease-in duration-150 hover:bg-green-500 hover:text-white-0 text-black-0 min-w-[160px]'>Call Now</button>
          </a>
          <HashLink smooth to="/contact">
            <button className='bg-grey-0 rounded-[4px] text-c-4-0 px-4 p-3 transition-all ease-in duration-150 hover:bg-green-500 hover:text-white-0 text-black-0 min-w-[160px]'>Get a Free Quote</button>
          </HashLink>
        </div>
      </section>
    </>
